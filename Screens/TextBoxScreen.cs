...
namespace GameProject6.Screens
{
    ...
    public class TextBoxScreen : GameScreen
    {
        ...
        public TextBoxScreen(string message, bool includeUsageText = true)
        {
            //sizeX = x;
            //sizeY = y;

            const string usageText = "\n\nPress Space or Enter to close this window.";
        ...
        public override void HandleInput(GameTime gameTime, InputState input)
        {
            ...
            if (_menuSelect.Occurred(input, ControllingPlayer, out playerIndex) || _menuCancel.Occurred(input, ControllingPlayer, out playerIndex))
            {
